...
Cada trabajo práctico vive en su propia carpeta, con sus fuentes de diseño, su
testbench de verificación y sus constraints para la placa:

    arquitectura_de_computadoras/
    ├── TP1_ALU/        Unidad aritmético-lógica parametrizable
    └── ...             Trabajos siguientes